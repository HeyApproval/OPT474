...
lib.ssMetadata = [
		{name:"OPT471_Display_Grandkids_esp_160x600_atlas_1", frames: [[314,602,306,176],[314,780,306,176],[0,602,312,228],[0,832,225,44],[0,0,400,600]]}
];
...
}).prototype = getMCSymbolPrototype(lib.HEAD3, new cjs.Rectangle(-76.5,0,153,88), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(-76.5,0,153,88), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(-78,0,156,114), null);
...
// stage content:
(lib.OPT471_Display_Grandkidsesp_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
