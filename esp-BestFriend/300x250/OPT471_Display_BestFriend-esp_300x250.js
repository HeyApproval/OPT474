...
lib.ssMetadata = [
		{name:"OPT471_Display_BestFriend_esp_300x250_atlas_1", frames: [[0,602,578,112],[0,716,578,112],[0,830,578,112],[402,0,188,37],[0,0,400,600]]}
];
...
(lib.CachedBmp_174 = function() {
	this.initialize(ss["OPT471_Display_BestFriend_esp_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,289,56), null);
...
// stage content:
(lib.OPT471_Display_BestFriendesp_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_BestFriend_esp_300x250_atlas_1.png?1662505922880", id:"OPT471_Display_BestFriend_esp_300x250_atlas_1"}
	],
	preloads: []
};
