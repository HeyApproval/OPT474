...
lib.ssMetadata = [
		{name:"OPT471_Display_BestFriend_esp_160x600_atlas_1", frames: [[314,602,306,184],[314,788,306,184],[0,602,312,293],[0,897,225,44],[0,0,400,600]]}
];
...
(lib.CachedBmp_170 = function() {
	this.initialize(ss["OPT471_Display_BestFriend_esp_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(-78,0,156,146.5), null);
...
// stage content:
(lib.OPT471_Display_BestFriendesp_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(150,285.9,1,1,0,0,0,0,25.9);
...
p.nominalBounds = new cjs.Rectangle(71,141.8,229.10000000000002,458.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_BestFriend_esp_160x600_atlas_1.png?1662505918212", id:"OPT471_Display_BestFriend_esp_160x600_atlas_1"}
	],
	preloads: []
};
