...
lib.ssMetadata = [
		{name:"OPT471_Display_YearsAhead_300x250_atlas_1", frames: [[402,0,578,134],[402,136,578,134],[402,272,578,134],[402,408,188,39],[0,0,400,600]]}
];
...
(lib.CachedBmp_56 = function() {
	this.initialize(ss["OPT471_Display_YearsAhead_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD3, new cjs.Rectangle(0,0,289,67), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(0,0,289,67), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,289,67), null);
...
// stage content:
(lib.OPT471_Display_YearsAhead_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(197.2,204.35,0.295,0.295,0,0,0,305.9,306.1);
...
p.nominalBounds = new cjs.Rectangle(149.5,-41.2,151,335.59999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_YearsAhead_300x250_atlas_1.png?1662499281960", id:"OPT471_Display_YearsAhead_300x250_atlas_1"}
	],
	preloads: []
};
