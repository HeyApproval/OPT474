...
lib.ssMetadata = [
		{name:"OPT471_Display_YearsAhead_728x90_atlas_1", frames: [[402,0,578,153],[402,155,578,153],[0,602,684,153],[686,310,188,39],[0,0,400,600]]}
];
...
(lib.CachedBmp_68 = function() {
	this.initialize(ss["OPT471_Display_YearsAhead_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,342,76.5), null);
...
// stage content:
(lib.OPT471_Display_YearsAhead_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_7.setTransform(448.85,58.45,0.84,0.84,0,0,0,0.3,0.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_YearsAhead_728x90_atlas_1.png?1662499295315", id:"OPT471_Display_YearsAhead_728x90_atlas_1"}
	],
	preloads: []
};
