...
lib.ssMetadata = [
		{name:"OPT471_Display_Grandkids_160x600_atlas_1", frames: [[314,602,306,184],[314,788,306,184],[0,602,312,238],[0,842,225,47],[0,0,400,600]]}
];
...
(lib.CachedBmp_44 = function() {
	this.initialize(ss["OPT471_Display_Grandkids_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.OPT471_Display_Grandkids_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(70,141.8,230.10000000000002,458.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_Grandkids_160x600_atlas_1.png?1662498672607", id:"OPT471_Display_Grandkids_160x600_atlas_1"}
	],
	preloads: []
};
