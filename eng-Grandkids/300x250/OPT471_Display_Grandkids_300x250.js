...
lib.ssMetadata = [
		{name:"OPT471_Display_Grandkids_300x250_atlas_1", frames: [[402,0,578,134],[402,136,578,134],[402,272,578,134],[402,408,188,39],[0,0,400,600]]}
];
...
(lib.CachedBmp_48 = function() {
	this.initialize(ss["OPT471_Display_Grandkids_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.OPT471_Display_Grandkids_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149.5,-41.2,158.3,309.59999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_Grandkids_300x250_atlas_1.png?1662498687835", id:"OPT471_Display_Grandkids_300x250_atlas_1"}
	],
	preloads: []
};
