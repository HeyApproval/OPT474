...
lib.ssMetadata = [
		{name:"OPT471_Display_Caregiver_esp_728x90_atlas_1", frames: [[402,0,578,153],[402,155,578,153],[0,602,714,153],[716,310,188,37],[0,0,400,600]]}
];
...
(lib.CachedBmp_130 = function() {
	this.initialize(ss["OPT471_Display_Caregiver_esp_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD3, new cjs.Rectangle(0,0,289,76.5), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(0,0,289,76.5), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,357,76.5), null);
...
// stage content:
(lib.OPT471_Display_Caregiveresp_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_7.setTransform(454.85,92.45,0.84,0.84,0,0,0,0.3,0.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_Caregiver_esp_728x90_atlas_1.png?1662504890248", id:"OPT471_Display_Caregiver_esp_728x90_atlas_1"}
	],
	preloads: []
};
