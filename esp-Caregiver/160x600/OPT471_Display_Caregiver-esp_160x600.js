...
lib.ssMetadata = [
		{name:"OPT471_Display_Caregiver_esp_160x600_atlas_1", frames: [[314,788,306,184],[314,602,315,184],[0,602,312,238],[0,842,225,44],[0,0,400,600]]}
];
...
(lib.CachedBmp_126 = function() {
	this.initialize(ss["OPT471_Display_Caregiver_esp_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-78.75,14,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(-78.7,14,157.5,92), null);
...
// stage content:
(lib.OPT471_Display_Caregiveresp_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_Caregiver_esp_160x600_atlas_1.png?1662504876365", id:"OPT471_Display_Caregiver_esp_160x600_atlas_1"}
	],
	preloads: []
};
