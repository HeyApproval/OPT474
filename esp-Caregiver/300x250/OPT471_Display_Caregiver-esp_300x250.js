...
lib.ssMetadata = [
		{name:"OPT471_Display_Caregiver_esp_300x250_atlas_1", frames: [[0,727,578,123],[0,852,578,123],[0,602,580,123],[0,977,188,37],[0,0,400,600]]}
];
...
(lib.CachedBmp_143 = function() {
	this.initialize(ss["OPT471_Display_Caregiver_esp_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD3, new cjs.Rectangle(0,0,289,61.5), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(0,0,289,61.5), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,290,61.5), null);
...
// stage content:
(lib.OPT471_Display_Caregiveresp_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(46,230);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(202));

	// CTA
	this.instance_1 = new lib.CTA();
	this.instance_1.setTransform(54.6,116,1,1,0,0,0,0,10);
	...
	this.instance_3.setTransform(194.2,158.35,0.295,0.295,0,0,0,305.9,306.1);
	...
	this.instance_5.setTransform(150,95.9,1,1,0,0,0,0,25.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(86).to({y:-19},8,cjs.Ease.quadIn).to({_off:true},1).wait(107));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(94).to({_off:false},0).to({y:41},8,cjs.Ease.quadOut).wait(67).to({y:-19},8,cjs.Ease.quadIn).to({_off:true},1).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(177).to({_off:false},0).to({y:41},8,cjs.Ease.quadOut).wait(17));

	// bkgd
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FBF9F4").s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
...
p.nominalBounds = new cjs.Rectangle(149.5,-41.2,151,305.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT471_Display_Caregiver_esp_300x250_atlas_1.png?1662504906754", id:"OPT471_Display_Caregiver_esp_300x250_atlas_1"}
	],
	preloads: []
};
